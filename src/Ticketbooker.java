...
public class Ticketbooker
{
    ...
    static int availableLowerBerths = 5;//normally 5
    static int availableMiddleBerths = 5;//normally 5
    static int availableUpperBerths = 5;//normally 5
    static int availableRacTickets = 5;//normally 5
    static int availableWaitingList = 5;//normally 5
    ...
    static List<Integer> lowerBerthsPositions = new ArrayList<>(Arrays.asList(1,2,3,4,5));//normally 1,2,3,4,5
    static List<Integer> middleBerthsPositions = new ArrayList<>(Arrays.asList(1,2,3,4,5));//normally 1,2,3,4,5
    static List<Integer> upperBerthsPositions = new ArrayList<>(Arrays.asList(1,2,3,4,5));//normally 1,2,3,4,5
    static List<Integer> racPositions = new ArrayList<>(Arrays.asList(1,2,3,4,5));//normally 1,2,3,4,5
    static List<Integer> waitingListPositions = new ArrayList<>(Arrays.asList(1,2,3,4,5));//normally 1,2,3,4,5
    ...
    public void bookTicket(Passenger p, int berthInfo,String allotedBerth)
    {
        ...
        System.out.println(p.name + "'s Seat Booked Successfully");
    }
    ...
    public void addToRAC(Passenger p,int racInfo,String allotedRAC)
    {
        ...
        System.out.println(p.name + "'s added to RAC Successfully");
    }
    ...
    public void addToWaitingList(Passenger p,int waitingListInfo,String allotedWL)
    {
        ...
        System.out.println(p.name + "'s added to Waiting List Successfully");
    }
    ...
    public void cancelTicket(int passengerId)
    {
        ...
        System.out.println("ID number "+p.number + " Seat cancelled Successfully");
